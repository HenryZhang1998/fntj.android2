...
//
//                CameraSelector.Builder opt = new CameraSelector.Builder().requireLensFacing(LENS_FACING_BACK);
//                //CameraSelector.Builder opt = new CameraSelector.Builder().requireLensFacing(LENS_FACING_FRONT);
//
//                //相机选择器
//                CameraSelector cameraSelector = mCameraConfig.options(opt);
//                //设置SurfaceProvider
////                preview.setSurfaceProvider(mPreviewView.getSurfaceProvider());
//
//                //图像分析
//                ImageAnalysis imageAnalysis = mCameraConfig.options(new ImageAnalysis.Builder().setBackpressureStrategy(ImageAnalysis.STRATEGY_KEEP_ONLY_LATEST));
